...
public class LoginGUI {
    ...
    public void create() {
        ...
        gbl_panel.columnWidths = new int[]{33, 51, 106, 324, 106, 173, -107, -83, 93, 0};
        ...
        panel_1 = new JPanel();
        ImageIcon ic = new ImageIcon("../breakingVADicon.png");
        System.out.println(new File("../breakingVADicon.png").exists());
        panel_1.add(new JLabel(ic));
